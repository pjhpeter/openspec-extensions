...
当前仓库已经完成 TS CLI cutover；标准运行路径就是 `openspec-extensions ...`，仓库中不再保留 Python runtime / installer 作为兼容层。
...
迁移发布说明、升级路径和回滚策略见 [`docs/ts-migration-release-notes.md`](./docs/ts-migration-release-notes.md)。
